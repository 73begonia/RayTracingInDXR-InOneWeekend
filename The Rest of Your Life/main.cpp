...
int main()
{
	HWND hwnd = createWindow(L"The Rest of Your Life", gWidth, gHeight);
	...
	Scene* scene = sceneLoader.push_CornellBox();
...
HWND createWindow(const wchar* winTitle, uint width, uint height)
{
	...
	wc.lpszClassName = L"RayTracingInDXR_03";
