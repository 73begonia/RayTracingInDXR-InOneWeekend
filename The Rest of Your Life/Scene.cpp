...
Scene* SceneLoader::push_CornellBox()
{
	Scene* scene = new Scene;
	sceneArr.push_back(scene);

	Mesh ground = generateRectangleMesh(float3(0.0f, -2.f, 0.0f), float3(7.f, 0.f, 7.f), FaceDir::up);
	Mesh leftWall = generateRectangleMesh(float3(-3.5f, 1.5f, 0.0f), float3(0.f, 7.f, 7.f), FaceDir::right);
	Mesh ceiling = generateRectangleMesh(float3(0.0f, 5.0f, 0.0f), float3(7.f, 0.f, 7.f), FaceDir::down);
	Mesh rightWall = generateRectangleMesh(float3(3.5f, 1.5f, 0.0f), float3(0.f, 7.f, 7.f), FaceDir::left);
	Mesh backWall = generateRectangleMesh(float3(0.0f, 1.5f, -3.5f), float3(7.f, 7.f, 0.f), FaceDir::front);
	Mesh sphere1 = generateSphereMesh(float3(-2.5f, 1.0f, 0.0f), 1.f);
	Mesh sphere2 = generateSphereMesh(float3(0.f, 1.0f, 0.0f), 1.f);
	Mesh sphere3 = generateSphereMesh(float3(2.5f, 1.0f, 0.0f), 1.f);
	Mesh quadLight = generateRectangleMesh(float3(0.0f, 4.99f, 0.f), float3(3.0f, 0.f, 3.0f), FaceDir::down);

	initializeGeometryFromMeshes(scene,
		{ &ground, &leftWall, &ceiling, &rightWall, &backWall, &sphere1, &sphere2, &sphere3, &quadLight });
	...
	//leftWall
	mtlArr[1].baseColor = float3(1.f, 0.f, 0.f);
	//ceiling
	mtlArr[2].baseColor = 1.f;
	//rightWall
	mtlArr[3].baseColor = float3(0.f, 1.f, 0.f);
	//backWall
	mtlArr[4].baseColor = 1.f;

	//sphere1
	mtlArr[5].baseColor = float3(0.79f, 0.59f, 0.60f);

	//sphere2
	mtlArr[6].baseColor = float3(0.56f, 0.73f, 0.53f);
	mtlArr[6].anisotropic = 1.f;
	mtlArr[6].metallic = 0.9f;
	mtlArr[6].roughness = 0.1f;
	mtlArr[6].specular = 1.0f;
	mtlArr[6].subsurface = 1.0f;

	//sphere3
	mtlArr[7].baseColor = float3(0.49f, 0.48f, 0.67f);

	//Light
	mtlArr[8].emissive = float3(5.0f);
